  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="h-screen flex flex-col justify-between items-center bg-background text-white">
        ...
        <h1 className="text-black lg:text-3xl text-lg mt-10 mb-10 font-bold">Calculadora de impuesto de renta</h1>
        ...
        <p className="text-black">v1.1 - {(new Date()).getFullYear()}</p>
      </div>
    </form>
  )
};
